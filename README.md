...
### Notes
The App determins the Hostility of the CoT Symbol Code based on the nationality as encoded in the first three digits of the MMSI. For example 316 is Canada. 
