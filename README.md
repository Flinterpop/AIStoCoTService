...
If a vessel is Canadian then it's symbol is friendly. If the country is in the file `web_root/hostilitylist.csv` then it is marked hostile. All others are marked Neutral. 
